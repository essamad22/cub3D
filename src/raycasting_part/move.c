...
/*   Updated: 2024/02/29 20:58:05 by aakhtab          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    int c = 0;
    if (par->map[(int)par->player->posY / 64][(int)(par->player->posX + par->player->dirX) / 64] == '0')
    {
        par->player->posX += par->player->dirX;
        c = 1;
    }
    if (par->map[(int)(par->player->posY + par->player->dirY) / 64][(int)par->player->posX / 64] == '0')
    {
